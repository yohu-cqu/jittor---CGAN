...
for epoch in range(opt.n_epochs):
    ...
    if epoch % 10 == 0:
        generator.save("model/generator_last.pkl")
        discriminator.save("model/discriminator_last.pkl")

generator.eval()
discriminator.eval()
generator.load('model/generator_last.pkl')
discriminator.load('model/discriminator_last.pkl')
